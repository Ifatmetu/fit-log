...
import { getApps } from '@/lib/Datafetch';
            ...
            <div className="mx-auto grid max-w-6xl grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                {data.map((app: TApps) => (
                    <Link
                        ...
                        className="block overflow-hidden rounded-2xl border border-white/5 bg-[#171a20] shadow-lg transition duration-300 hover:-translate-y-1 hover:border-white/10"
                    >
